...
import com.gkgio.museum.activity.BottomBarTabsSwitcher;
...
public class SupportAppNavigator implements Navigator {
    ...
    private void fragmentForwardTo(SwitchTo command) {
        ...
        if (command.getId() == R.id.tab_museums) {
            fragment.switchToMuseumsTab();
        } else if (command.getId() == R.id.tab_audios) {
            fragment.switchToAudiosTab();
